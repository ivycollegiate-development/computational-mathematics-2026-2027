# Day 11 — LAB: Calculator v1 — Safe Arithmetic (Fri 2026-09-18)
...
Use the patterns from Wednesday's lesson. Run `python3 test_calculator.py`
...
## PART 4 — TURN IN (due 11:59 PM tonight)
